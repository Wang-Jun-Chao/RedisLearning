 ...
 **/
public class LPushX extends Command<String, String> {
    private final static Logger logger = LoggerFactory.getLogger(LPushX.class);
    ...
    public void testTemplate() {
        ...
        template.opsForList().leftPushIfPresent("myotherlist", "Hello");
    ...
    public void testConnection() {
        ...
        connection.lPushX(keySerializer.serialize("myotherlist"), valueSerializer.serialize("Hello"));
