 ...
 * All Rights Reserved !!!
 */
public class SInterStore extends Command<String, String> {
    @Test
    @Override
    public void testTemplate() {
        ...
        Long diff = template.opsForSet().intersectAndStore("key1", "key2", "key");
        System.out.println(diff);
        Assert.assertEquals(Long.valueOf(1), diff);

        Set<String> members = template.opsForSet().members("key");
        Set<String> values = Sets.newHashSet("c");
    ...
    public void testConnection() {
        ...
        Long diff = connection.sInterStore(
